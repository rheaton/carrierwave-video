    ...
    private
      def with_trancoding_callbacks(&block)
        ...
        begin
          ...
          raise CarrierWave::ProcessingError.new("Failed to transcode with FFmpeg. Check ffmpeg imstall and verify video is not corrupt or cut short. Original error: #{e}")
        ensure
          reset_logger
